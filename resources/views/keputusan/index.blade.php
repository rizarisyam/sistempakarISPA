        ...
        <form action="" method="GET">
          ...
          <div class="input-group my-4 mb-2">
            ...
            <div class="input-group-append">
              <button class="btn btn-outline-primary" type="submit"><i class="fas fa-search mr-2"></i>Button</button>
            </div>
          </div>
        </form>
      </div>
            ...
            <td>
              <div class="btn-group bg-primary" role="group" aria-label="Basic example">
                <a href="{{route('keputusan.edit', $row->id)}}">
                  <button type="button" class="btn btn-primary"><i class="far fa-edit text-white"></i></button>
                </a>
                <form action="{{route('keputusan.destroy', $row->id)}}" method="post"
                  onsubmit='return confirm("Are you sure you want to delete?");'>
                  @csrf
                  @method('DELETE')
                  <button type="submit" class="btn btn-primary"><i class="fas fa-trash text-white"></i></button>
                </form>
              </div>
