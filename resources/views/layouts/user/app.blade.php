...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo mr-auto"><a href="index.html">Sistem Pakar ISPA</a></h1>
            ...
            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    ...
                    <li class="{{Request::routeIs('user-konsultasi.*') ? 'active' : ''}}"><a href="{{route('user-konsultasi.index')}}">Konsultasi</a></li>
                    <li class="{{Request::routeIs('history-user.*') ? 'active' : ''}}"><a href="{{route('history-user.index')}}">Data Riwayat</a></li>
                    <li><a href="{{route('user-setting.index')}}">Data Profil</a></li>
                    <li>
