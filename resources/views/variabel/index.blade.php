    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center border-bottom py-2">
            ...
            <div>
                <div class="btn-group btn-group-justified">
                    ...
                    <div class="btn-group">
                        <a href="{{route('variabel.create')}}" class="btn btn-primary" role="button">
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <form action="{{ route('variabel.excel') }}" method="post" enctype="multipart/form-data">
                            @csrf
        ...
        <div class="table-responsive mt-2">
            <table class="table text-dark" id="tableVariabel">
                ...
                <tbody>
                    @forelse ($variabel as $key=>$row)
                    <tr>
                        <th scope="row" class="text-dark">{{$variabel->firstItem() + $key}}</th>
                        <td>{{$row->kode}}</td>
                        <td>{{$row->nama}}</td>
                        <td>
                        ...
                        <td>
                            <div class="btn-group bg-primary" role="group" aria-label="Basic example">
                                <a href="{{route('variabel.edit', $row->id)}}">
