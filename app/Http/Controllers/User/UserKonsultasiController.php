...
class UserKonsultasiController extends Controller
{
    ...
    {
        return view($this->path . ".konsultasi.index");
    }
    ...
    {
        return view($this->path . ".konsultasi.create");
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user.konsultasi.pertanyaan');
    }
    ...
    public function konsultasi()
    {
        ...
        return view("user.konsultasi.konsultasi", compact(['variabel']));
    }
    ...
    public function handleKonsultasi(Request $request)
    {
        ...
        return redirect()->route('user.konsultasi.hasilDiagnosa');
    }
    ...
    public function hasilDiagnosa()
    {
        ...
        return redirect()->route('user.konsultasi.showDiagnosa');
    }
    ...
    public function showDiagnosa()
    {
        ...
        return view('user.konsultasi.diagnosa', compact(['penyakit', 'persentase', 'konsultasi']));
    }
